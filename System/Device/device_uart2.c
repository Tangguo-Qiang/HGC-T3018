...
static TestStatus WriteStringByUsart2(uint8_t* data,uint8_t length) 
{
	uint8_t i;
...
//	System.Device.Usart2.WriteByte=WriteByteToUsart2;
	System.Device.Usart2.WriteString=WriteStringByUsart2;
