...
#define SIZEOF_RFADDRID  		(sizeof(App.RfAddrID))		//180 bytes
...
#define EEPROM_ADDRESS_RFADDRID  		(EEPROM_ADDRESS_ENVPARA+SIZEOF_ENVPARA)		//180 bytes
